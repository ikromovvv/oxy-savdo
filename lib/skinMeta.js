...
export const RARITIES = {
  ...
  classified: { key: 'classified', label: 'Classified', color: '#d32ee6' },
  covert: { key: 'covert', label: 'Covert', color: '#eb4b4b' },
  contraband: { key: 'contraband', label: 'Contraband', color: '#e4ae39' },
  gold: { key: 'gold', label: 'Extraordinary', color: '#e4ae39' },
};
