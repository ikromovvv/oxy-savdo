...
// FAQAT testlar uchun: katalog keshini oldindan to'ldiradi (tarmoqsiz).
export function __seedCatalogForTest(items) {
  memCache = { items, weaponTypes: [...new Set(items.map((i) => i.weaponType))], ts: Date.now() };
}
